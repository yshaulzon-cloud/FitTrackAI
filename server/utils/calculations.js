...
const FOOD_DB = [
  ...
  // === Gemini Research 2026 — additional foods ===
  // Chocolate bars & candy
  { keys: ['קינדר סורפריז', 'kinder surprise'], cal: 552, p: 8, c: 52, f: 34, fb: 0 },
  { keys: ['מארס', 'mars bar'], cal: 448, p: 4, c: 69, f: 17, fb: 1 },
  { keys: ['באונטי', 'bounty'], cal: 487, p: 3.8, c: 59, f: 26, fb: 1.6 },
  { keys: ['סקיטלס', 'skittles'], cal: 405, p: 0, c: 91, f: 4.2, fb: 0 },
  { keys: ['פינגווין', 'penguin chocolate'], cal: 518, p: 5.3, c: 62.4, f: 27.2, fb: 1.4 },
  { keys: ['טופלרון', 'toblerone'], cal: 525, p: 5.4, c: 60, f: 29, fb: 2 },
  { keys: ['ריטר ספורט', 'ritter sport'], cal: 530, p: 6, c: 55, f: 31, fb: 3 },
  { keys: ['הרשיז', 'hershey', "hershey's kisses"], cal: 500, p: 6, c: 59, f: 29, fb: 3 },
  { keys: ['מאלטיזרס', 'maltesers'], cal: 503, p: 8.1, c: 66, f: 23, fb: 1 },
  { keys: ['עלית סוויט', 'elite sweet', 'עלית שוקולד'], cal: 530, p: 6, c: 55, f: 31, fb: 2 },
  { keys: ['באטרפינגר', 'butterfinger'], cal: 459, p: 7.4, c: 68, f: 19, fb: 2 },
  { keys: ['סמרטיז', 'smarties'], cal: 470, p: 4, c: 74, f: 17, fb: 1 },
  { keys: ["וורת'ר אוריג'ינל", 'werthers original'], cal: 420, p: 0, c: 87, f: 8, fb: 0 },
  { keys: ['קרטיב', 'kartiv'], cal: 80, p: 0, c: 20, f: 0, fb: 0 },

  // Baked goods & desserts
  { keys: ["צ'יזקייק", 'cheesecake'], cal: 401, p: 7, c: 32, f: 28, fb: 1 },
  { keys: ['מקרון', 'macaron'], cal: 90, p: 2, c: 13, f: 4, fb: 0 },
  { keys: ['דונאט', 'donut', 'doughnut'], cal: 400, p: 5, c: 45, f: 22, fb: 1 },
  { keys: ['מלבי', 'malabi'], cal: 120, p: 2, c: 20, f: 3, fb: 0 },
  { keys: ['עוגיות פיצוחיו', 'pistachio cookies'], cal: 500, p: 10, c: 50, f: 30, fb: 5 },
  { keys: ['חמוציות מסוכרות', 'dried cranberries', 'קרנברי'], cal: 308, p: 0.1, c: 82, f: 1, fb: 5 },
  { keys: ['מאפינס בלוברי', 'blueberry muffin'], cal: 370, p: 5, c: 52, f: 15, fb: 1.5 },
  { keys: ['הוסטס', 'hostess cupcake'], cal: 366, p: 3.5, c: 61, f: 12, fb: 2 },
  { keys: ["פאוור קראנץ'", 'power crunch bar'], cal: 500, p: 32, c: 25, f: 32, fb: 2 },
  { keys: ['פבלובה', 'pavlova'], cal: 350, p: 3, c: 65, f: 10, fb: 1 },
  { keys: ['פאי מיט', 'meat pie', 'aussie meat pie'], cal: 280, p: 10, c: 25, f: 15, fb: 2 },
  { keys: ['דייפוקו', 'daifuku', "מוצ'י"], cal: 230, p: 4, c: 52, f: 0.5, fb: 2 },
  { keys: ['טאיאקי', 'taiyaki'], cal: 250, p: 5, c: 40, f: 8, fb: 1 },
  { keys: ["פוקצ'ינה", 'focaccia'], cal: 243, p: 5, c: 33, f: 11, fb: 2 },
  { keys: ['ביסקוויט חיתוך', 'teething biscuit'], cal: 423, p: 9.7, c: 70, f: 10, fb: 3 },
  { keys: ["צ'בטה", 'ciabatta'], cal: 260, p: 9, c: 50, f: 2, fb: 2 },

  // Dairy & cheese
  { keys: ['אקטימל', 'actimel'], cal: 72, p: 2.8, c: 11.5, f: 1.5, fb: 0 },
  { keys: ['יופלה', 'yoplait'], cal: 95, p: 3.5, c: 14, f: 2.5, fb: 0 },
  { keys: ['דניאלה', 'daniela yogurt'], cal: 115, p: 5, c: 15, f: 4, fb: 0 },
  { keys: ['אשל', 'eshel'], cal: 60, p: 3, c: 4.5, f: 4.5, fb: 0 },
  { keys: ['פילדלפיה', 'philadelphia cream cheese'], cal: 342, p: 6, c: 4, f: 34, fb: 0 },
  { keys: ['הגן דאז', 'haagen dazs'], cal: 270, p: 4, c: 22, f: 18, fb: 0 },
  { keys: ['גורגונזולה', 'gorgonzola'], cal: 314, p: 21, c: 0.4, f: 26, fb: 0 },
  { keys: ['פקורינו', 'pecorino', 'pecorino romano'], cal: 387, p: 26, c: 0, f: 32, fb: 0 },
  { keys: ['רוקפור', 'roquefort'], cal: 369, p: 21.5, c: 2, f: 30.6, fb: 0 },
  { keys: ['מסקרפונה', 'mascarpone'], cal: 429, p: 4.6, c: 4, f: 44, fb: 0 },
  { keys: ['סטילטון', 'stilton'], cal: 410, p: 24, c: 0.1, f: 35, fb: 0 },
  { keys: ["טאלג'יו", 'taleggio'], cal: 294, p: 19, c: 0.5, f: 24, fb: 0 },
  { keys: ['פונטינה', 'fontina'], cal: 389, p: 25.6, c: 1.5, f: 31, fb: 0 },
  { keys: ['רקלט', 'raclette'], cal: 348, p: 24, c: 1.4, f: 27, fb: 0 },
  { keys: ['אסיאגו', 'asiago'], cal: 392, p: 25, c: 3.4, f: 30, fb: 0 },
  { keys: ["מנצ'גו", 'manchego'], cal: 320, p: 24, c: 0.5, f: 25, fb: 0 },
  { keys: ['בורסין', 'boursin'], cal: 400, p: 7.5, c: 2.5, f: 40, fb: 0 },

  // Cereals & crackers
  { keys: ['פרוסטיז', 'frosties', 'frosted flakes'], cal: 375, p: 4.5, c: 87, f: 0.6, fb: 2 },
  { keys: ["שוגי", 'sugary cereal'], cal: 380, p: 5, c: 85, f: 1, fb: 2 },
  { keys: ["לאקי צ'ארמס", 'lucky charms'], cal: 396, p: 7.6, c: 82.5, f: 3.6, fb: 7.6 },
  { keys: ['וויטביקס', 'weetabix'], cal: 358, p: 11.5, c: 68.6, f: 2, fb: 10 },
  { keys: ['שרדד וויט', 'shredded wheat'], cal: 362, p: 12.3, c: 68, f: 2.1, fb: 11.7 },
  { keys: ['טריסקיט', 'triscuit'], cal: 428, p: 10, c: 71, f: 14, fb: 10 },

  // Meat & fish
  { keys: ['אסאדו', 'asado', 'beef ribs'], cal: 350, p: 15, c: 0, f: 32, fb: 0 },
  { keys: ['בריסקט', 'brisket'], cal: 285, p: 17, c: 0, f: 24, fb: 0 },
  { keys: ['שפונדרה', 'short ribs'], cal: 350, p: 15, c: 0, f: 32, fb: 0 },
  { keys: ['קורקבן', 'oxtail'], cal: 94, p: 17.7, c: 0, f: 2.1, fb: 0 },
  { keys: ['אוסובוקו', 'ossobuco', 'veal ossobuco'], cal: 160, p: 20, c: 0, f: 8, fb: 0 },
  { keys: ['קבנוס', 'kabanos', 'kabanosy'], cal: 450, p: 22, c: 2, f: 40, fb: 0 },
  { keys: ['מרגז', 'merguez'], cal: 300, p: 15, c: 1, f: 25, fb: 0 },
  { keys: ['קרפיון', 'carp'], cal: 127, p: 17.8, c: 0, f: 5.6, fb: 0 },
  { keys: ['תמנון', 'octopus'], cal: 82, p: 14.9, c: 2.2, f: 1, fb: 0 },
  { keys: ['אבלון', 'abalone'], cal: 105, p: 17.1, c: 6, f: 0.8, fb: 0 },
  { keys: ['סורסטרומינג', 'surstromming', 'fermented herring'], cal: 120, p: 15, c: 0, f: 6, fb: 0 },

  // Soft drinks
  { keys: ['ספרייט', 'sprite'], cal: 40, p: 0, c: 10, f: 0, fb: 0 },
  { keys: ['דוקטור פפר', 'dr pepper', 'doctor pepper'], cal: 41, p: 0, c: 10.5, f: 0, fb: 0 },
  { keys: ['סבן אפ', '7up', 'seven up'], cal: 39, p: 0, c: 10, f: 0, fb: 0 },
  { keys: ['פוקארי סווט', 'pocari sweat'], cal: 25, p: 0, c: 6.2, f: 0, fb: 0 },
  { keys: ['גטוריידה', 'גטורייד', 'gatorade'], cal: 25, p: 0, c: 6, f: 0, fb: 0 },
  { keys: ['מונסטר', 'monster energy drink'], cal: 47, p: 0, c: 12, f: 0, fb: 0 },
  { keys: ['ברן', 'burn energy drink'], cal: 50, p: 0, c: 12, f: 0, fb: 0 },
  { keys: ['ויטמין ווטר', 'vitamin water'], cal: 20, p: 0, c: 5, f: 0, fb: 0 },
  { keys: ['מאסטר אנרגיה', 'master energy'], cal: 45, p: 0, c: 11, f: 0, fb: 0 },
  { keys: ['לוקוזייד', 'lucozade'], cal: 35, p: 0, c: 8.5, f: 0, fb: 0 },
  { keys: ['פאוורייד', 'powerade'], cal: 16, p: 0, c: 3.9, f: 0, fb: 0 },
  { keys: ['בודיארמור', 'bodyarmor'], cal: 30, p: 0, c: 7, f: 0, fb: 0 },
  { keys: ['סקוויז', 'sqeez', 'squeez drink'], cal: 40, p: 0, c: 10, f: 0, fb: 0 },
  { keys: ['בנג', 'bang energy'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['סן פלגרינו', 'san pellegrino'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['פפסי מקס', 'pepsi max'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['קריסטל פפסי', 'crystal pepsi'], cal: 41, p: 0, c: 11, f: 0, fb: 0 },
  { keys: ["אורנג'ינה", 'orangina'], cal: 42, p: 0.1, c: 10, f: 0, fb: 0 },
  { keys: ['יורוקפה', 'eurocafe iced coffee'], cal: 2, p: 0, c: 0, f: 0, fb: 0 },

  // Alcohol
  { keys: ['פרוסקו', 'prosecco'], cal: 100, p: 0, c: 3, f: 0, fb: 0 },
  { keys: ['נגרוני', 'negroni'], cal: 200, p: 0, c: 15, f: 0, fb: 0 },
  { keys: ['דאיקירי', 'daiquiri'], cal: 186, p: 0, c: 15, f: 0, fb: 0 },
  { keys: ['קורונה', 'corona extra', 'corona beer'], cal: 42, p: 0.3, c: 4, f: 0, fb: 0 },
  { keys: ['היינקן', 'heineken'], cal: 42, p: 0.4, c: 3.2, f: 0, fb: 0 },
  { keys: ['בודווייזר', 'budweiser'], cal: 41, p: 0.3, c: 3, f: 0, fb: 0 },
  { keys: ['קפטן מורגן', 'captain morgan'], cal: 220, p: 0, c: 0.4, f: 0, fb: 0 },
  { keys: ['טובורג', 'tuborg'], cal: 42, p: 0.4, c: 3, f: 0, fb: 0 },
  { keys: ['קרלסברג', 'carlsberg'], cal: 43, p: 0.3, c: 3.2, f: 0, fb: 0 },
  { keys: ['סטלה ארטואה', 'stella artois'], cal: 43, p: 0.4, c: 3.5, f: 0, fb: 0 },
  { keys: ['האוואנה קלאב', 'havana club rum'], cal: 230, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['מרטיני', 'martini bianco', 'martini vermouth'], cal: 145, p: 0, c: 15, f: 0, fb: 0 },
  { keys: ['ראקיה', 'rakia', 'rakija'], cal: 230, p: 0, c: 0, f: 0, fb: 0 },

  // Tea & coffee
  { keys: ['תה ממותק', 'iced tea', 'sweet tea'], cal: 90, p: 0, c: 23, f: 0, fb: 0 },
  { keys: ['טוויניניגס', 'twinings'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['פיקוויק', 'pickwick tea'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['אחמד תה', 'ahmad tea'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['רויבוס', 'rooibos', 'red bush tea'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ["טאצ'ינו", 'teeccino'], cal: 250, p: 0, c: 66.6, f: 0, fb: 0 },
  { keys: ["פראפוצ'ינו", 'starbucks frappuccino', 'frappuccino'], cal: 70, p: 2, c: 12, f: 1.5, fb: 0 },

  // World cuisine
  { keys: ['ביבימבאפ', 'bibimbap'], cal: 150, p: 6, c: 20, f: 4, fb: 2 },
  { keys: ['טוקבוקי', 'tteokbokki'], cal: 200, p: 4, c: 40, f: 2, fb: 2 },
  { keys: ['אונגירי', 'onigiri', 'rice ball'], cal: 160, p: 3, c: 35, f: 1, fb: 1 },
  { keys: ['יקיניקו', 'yakiniku'], cal: 250, p: 20, c: 5, f: 15, fb: 0 },
  { keys: ["לחמג'ון", 'lahmajoun'], cal: 220, p: 10, c: 25, f: 8, fb: 2 },
  { keys: ['סוטלאקי', 'souvlaki'], cal: 110, p: 3, c: 20, f: 2, fb: 0 },
  { keys: ['באפלו ווינגס', 'buffalo wings'], cal: 290, p: 15, c: 0, f: 25, fb: 0 },
  { keys: ['קורנדוג', 'corn dog'], cal: 250, p: 9, c: 24, f: 13, fb: 1 },
  { keys: ['ביסקוויטים וגרייבי', 'biscuits and gravy'], cal: 280, p: 6, c: 28, f: 16, fb: 1 },
  { keys: ["קלאם צ'אודר", 'clam chowder'], cal: 95, p: 4, c: 10, f: 4, fb: 1 },
  { keys: ["ג'מבלאיה", 'jambalaya'], cal: 130, p: 7, c: 15, f: 4, fb: 1 },
  { keys: ['מופונגו', 'mofongo'], cal: 300, p: 6, c: 30, f: 18, fb: 4 },
  { keys: ['פסטליטוס', 'pastelitos'], cal: 320, p: 10, c: 35, f: 15, fb: 2 },
  { keys: ['וונטון', 'wonton'], cal: 300, p: 8, c: 35, f: 14, fb: 2 },
  { keys: ['צלעות חזיר BBQ', 'pork ribs bbq'], cal: 350, p: 15, c: 20, f: 23, fb: 0 },
  { keys: ['פרנקפורטר', 'frankfurter', 'hot dog sausage'], cal: 290, p: 12, c: 2, f: 26, fb: 0 },
  { keys: ['פתוש', 'fattoush'], cal: 90, p: 2, c: 10, f: 5, fb: 2 },
  { keys: ['שיש טאוק', 'shish tawook'], cal: 160, p: 22, c: 2, f: 6, fb: 0 },
  { keys: ["אינג'רה", 'injera', 'ethiopian bread'], cal: 150, p: 5, c: 30, f: 1, fb: 3 },
  { keys: ['בוביוטי', 'bobotie'], cal: 243, p: 15.8, c: 17, f: 13, fb: 2.5 },

  // Exotic fruits & vegetables
  { keys: ["פיג'ויה", 'feijoa'], cal: 55, p: 1, c: 10, f: 0.8, fb: 6 },
  { keys: ["ג'קפרוט", 'jackfruit'], cal: 95, p: 1.7, c: 23.2, f: 0.6, fb: 1.5 },
  { keys: ['חמציץ', 'sorrel', 'wood sorrel'], cal: 22, p: 2, c: 3.2, f: 0.7, fb: 2.9 },
  { keys: ["צ'רימויה", 'cherimoya', 'custard apple'], cal: 75, p: 1.5, c: 17.7, f: 0.6, fb: 3 },
  { keys: ['כמהין שחור', 'black truffle', 'truffle'], cal: 25, p: 2, c: 4, f: 0.5, fb: 2 },

  // Spices & blends
  { keys: ['זעתר', 'zaatar'], cal: 320, p: 10, c: 40, f: 15, fb: 10 },
  { keys: ['סומק', 'sumac'], cal: 300, p: 13, c: 38, f: 14, fb: 15 },
  { keys: ['רס אל חנות', 'ras el hanout'], cal: 310, p: 12, c: 50, f: 10, fb: 15 },

  // Supplements
  { keys: ['קריאטין', 'creatine monohydrate'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['HMB', 'beta-hmb supplement'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['בטא אלנין', 'beta alanine'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['אשווגנדה', 'ashwagandha'], cal: 270, p: 3.9, c: 46.9, f: 0.3, fb: 30 },
  { keys: ['ספירולינה', 'spirulina'], cal: 290, p: 57, c: 24, f: 7, fb: 3.6 },
  { keys: ['L-קרניטין', 'l-carnitine', 'carnitine supplement'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['מגנזיום ציטראט', 'magnesium citrate'], cal: 0, p: 0, c: 0, f: 0, fb: 0 },
  { keys: ['קולוסטרום', 'colostrum'], cal: 400, p: 80, c: 10, f: 5, fb: 0 },
  { keys: ['בטא גלוקאן', 'beta glucan'], cal: 380, p: 4, c: 90, f: 0, fb: 80 },
  { keys: ['ויטמין D', 'vitamin d', 'vitamin d3'], cal: 8, p: 0, c: 0, f: 1, fb: 0 },

  // Miscellaneous
  { keys: ['צימוקים זהובים', 'golden raisins', 'sultanas'], cal: 302, p: 3.4, c: 79.5, f: 0.5, fb: 3.3 },
  { keys: ['בוטנים מסוכרים', 'candied peanuts'], cal: 480, p: 15, c: 40, f: 30, fb: 6 },
  { keys: ['אורביט', 'orbit gum'], cal: 180, p: 0, c: 73, f: 0, fb: 0 },
  { keys: ['טריידנט', 'trident gum'], cal: 170, p: 0, c: 70, f: 0, fb: 0 },
